    ...
    for (let i = 0; i < amount; i += 1) {
      ...
      ObjectState.setObject(
        ...
        ObjectState.createGameObject({
          ...
          name: name,
          group: 'zombie',
          actions: ActionsManager.getActionsForGameObject('zombie', name),
          items: lootItemList,
          attack: attack,
          defense: defense,
    ...
    creaturesList.forEach(creature => {
      ...
      ObjectState.setObject(
        ...
        ObjectState.createGameObject({
          ...
          type: creature.type,
          group: 'zombie',
          actions: ActionsManager.getActionsForGameObject('creature', creature.name),
  ...
  spawnAnimal: function (object) {
    ...
    ObjectState.setObject(
      ...
      ObjectState.createGameObject({
        ...
        name: object.name,
        group: object.group,
        actions: object.name ? ActionsManager.getActionsForGameObject('animal', object.name) : [],
        items: object.items,
        attack: 0,
        defense: 0,
        dead: object.dead,
  ...
  spawnCompanionAt: function (x, y, companionName, forceStats) {
    ...
    ObjectState.setObject(
      ...
      ObjectState.createGameObject({
        ...
        name: companionName,
        group: 'animal',
        actions: ActionsManager.getActionsForGameObject('companion', companionName),
        items: lootItemList,
  ...
  setupWeapon: function (x, y, weaponName, forceStats) {
    ...
    ObjectState.setObject(
      ...
      ObjectState.createGameObject({
        ...
        group: 'weapon',
        actions: ActionsManager.getActionsForGameObject('weapon', weaponName),
