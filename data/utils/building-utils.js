 ...
 */
export function getBuildingTypeOf(buildingName) {
 ...
 */
export function getLootBuildingProbability(buildingName, character) {
 ...
 */
export function getBuildingActionsFor(buildingName, locked, infested, character) {
  const buildingType = getBuildingTypeOf(buildingName);
